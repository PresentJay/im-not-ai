...
- **효능 실측: [`docs/2026-09-05-en-efficacy-results.md`](docs/2026-09-05-en-efficacy-results.md)** — 게이트 위반 0%, 승격 지표 둘 다 유의 개선(p<.002), 변경률 중앙값 0.7% — **본문의 1/30 만 건드리고 같은 만큼 움직입니다.** 맨 프롬프트 대조군은 내용 43%·서법 64%·역주입 79% 에서 위반이 났습니다.
