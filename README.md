...
- **효능 실측: [`docs/2026-09-05-en-efficacy-results.md`](docs/2026-09-05-en-efficacy-results.md)** — 게이트 위반 0%·역행 0건이지만 변경률 중앙값 0.5%. **망가뜨리지 않지만 많이 하지도 않습니다.** 맨 프롬프트 대조군은 내용 43%·서법 64%·역주입 79% 에서 위반이 났습니다.
