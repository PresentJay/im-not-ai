...
├── commands/                      # Gemini CLI 커스텀 명령 (/humanize-korean, /humanize, /humanize-quick, /humanize-redo)
...
├── skills/                # 스킬 4종 (humanize-korean 오케스트레이터 + humanize·humanize-quick·humanize-redo 진입)
│   └── humanize-korean/
